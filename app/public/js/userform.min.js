	...
	var UserForm = _react2.default.createClass({
	  ...
	  createUserMessage: function createUserMessage() {
	    var UserMessage = _react2.default.createElement(
	      'h4',
	      { className: 'text-center', tabIndex: '3' },
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement('input', { type: 'submit', name: 'submit', value: this.props.submitvalue, className: 'btn btn-primary btn-block', tabIndex: '3', role: 'button' })
	      ),
