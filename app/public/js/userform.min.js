...
/***/ function(module, exports, __webpack_require__) {
	...
	var _userformcontainer = __webpack_require__(1);

	var _userformcontainer2 = _interopRequireDefault(_userformcontainer);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var ufc = React.createFactory(_userformcontainer2.default);
	ReactDOM.render(React.createElement(_userformcontainer2.default, { isLoggedIn: false, loginHeader: false }), document.getElementById('userform-mount'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _makerequest = __webpack_require__(3);

	var _makerequest2 = _interopRequireDefault(_makerequest);

	var _userform = __webpack_require__(5);
	...
	var UserFormContainer = _react2.default.createClass({
	  ...
	  handleCreateUser: function handleCreateUser(user) {
	    ...
	    this.makeRequest('/api/user', options).then(function (response) {
	      var self = _this2;
	      if (response.error) {
	        _this2.setState({ message: response.error });
	      } else {
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'div',
	      null,
	      _react2.default.createElement(_userform2.default, { className: 'form form-user',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserForm = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'form',
	      { handleSubmit: this.props.handleSubmit, className: this.props.className },
